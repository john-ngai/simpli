-- Project ID #1: Spring Cleaning > Deliverable ID #1: Main floor
...
-- Project ID #1: Spring Cleaning > Deliverable ID #2: 2nd floor
...
-- Project ID #1: Spring Cleaning > Deliverable ID #3: Basement
...
-- Project ID #1: Spring Cleaning > Deliverable ID #4: Garage
...
-- Project ID #1: Spring Cleaning > Deliverable ID #5: Yard
