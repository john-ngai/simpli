...
INSERT INTO deliverables (name, description, priority, status, project_id) VALUES ('Research best courses', 'YouTube, Udemy, Books, etc.', false, 'not started', 3);
INSERT INTO deliverables (name, description, priority, status, project_id) VALUES ('Create a self-learning schedule', '', false, 'not started', 3);
